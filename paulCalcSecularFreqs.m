...
modelDC = createpde();
importGeometry(modelDC,'FinalPaul.stl');
...
modelRF = createpde();
importGeometry(modelRF,'FinalPaul.stl');
...
Vpseudor = calcPseudoPot(resultRF,Xr,Yr,Zr,RFfreq);%<= Change from 2e6 Hz to a new RF frequency
...
Vpseudoa = calcPseudoPot(resultRF,Xa,Ya,Za,RFfreq);%<= Change from 2e6 Hz to a new RF frequency
