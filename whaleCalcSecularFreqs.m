...
modelDC = createpde();
importGeometry(modelDC,'finalWhaleTrap.stl');
...
modelRF = createpde();
importGeometry(modelRF,'finalWhaleTrap.stl');
...
% figure(1);
[Xr,Yr,Zr] = meshgrid(-2.5:0.001:2.5,0,0);
...
[RadialFrequency,SSRradial] = harmonicity(Xr,Vr,0.05,"Radial ");
...
[AxialFrequency,SSRaxial] = harmonicity(za,Va,0.05,"Axial ");
